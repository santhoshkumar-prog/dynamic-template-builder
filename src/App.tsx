...
const App: React.FC = () => {
  ...
  const COMPONENT_TYPES: Record<ElementType, ComponentConfig> = {
    ...
    ROW: { type: 'ROW', label: 'Two Column Row(50%)', icon: <ColumnsIcon size={18} />, defaultProps: { ...commonDefaults, ...labelDefaults, leftLabel: 'Field 1', leftMapping: 'none', hideLeftLabel: false, rightLabel: 'Field 2', rightMapping: 'none', hideRightLabel: false, useCustomHeight: false, customHeight: 50 } },
